                    ...
                    <div>
                        <div className='h-full w-full p-3 mb-16'>
                            <div className='relative'>
                                ...
                                <img src={"https://cdn.discordapp.com/attachments/1206017480901005336/1206023515602554900/language.jpg?ex=65da7fec&is=65c80aec&hm=f7deab9ca79f197e384af00d9753f72da0e33f2ac16c515fb96f8532cfb887c5&"} alt="img 1" className='h-72  rounded-t-lg w-full object-cover object-center ' />
                            </div>
