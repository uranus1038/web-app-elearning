                    ...
                    <div>
                        <div className='h-full w-full p-3 mb-16'>
                            <div className='relative'>
                                ...
                                <img src={"https://media.discordapp.net/attachments/1206017480901005336/1206023599341830194/work_Job.jpg?ex=65da8000&is=65c80b00&hm=da4a8f7a389bfeeed1e24e797ead02039ba8db0249e676bc209b837e5f79aa38&=&format=webp"} alt="img 1" className='h-72  rounded-t-lg w-full object-cover object-center ' />
                            </div>
