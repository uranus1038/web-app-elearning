            ...
            <div className='col-start-4 col-span-5 h-full '>
                ...
                <div className='flex justify-start w-full flex-wrap p-3 '>
                    ...
                    <Link to={'/activity/1'} className='w-full relative'>
                        <img src={"https://i.imgur.com/NIaw4Sx.jpg"} alt="img 1" loading="lazy" className=' start-col-4 mb-1 rounded-lg  h-28 w-full  object-cover object-left-top  brightness-50' />
                    ...
                    <Link to={'/activity/2'} className='w-full relative'>
                        <img src={"https://i.imgur.com/eS0ZwSA.jpg"} alt="img 2" loading="lazy" className='slide-down-1 start-col-4 mb-1 rounded-lg  h-28 w-full object-cover brightness-50' />
                    ...
                    <Link to={'/activity/3'} className='w-full relative'>
                        <img src={"https://i.imgur.com/emhpxMG.jpg"} alt="img 3" loading="lazy" className='slide-down-2 start-col-4 mb-1 rounded-lg  h-28 w-full  object-cover brightness-50' />
